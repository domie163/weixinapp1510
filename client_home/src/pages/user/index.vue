						...
						<view class="">
							<view  class="list_module">
									...
									<navigator class="my_module" url="/pages/registered_users/table" hover-class="hover">
										...
										<view v-if="user_group != '管理员' && $check_action('/traditional_chinese_medicine_classics/table','get')">
									<navigator class="my_module" url="/pages/traditional_chinese_medicine_classics/table" hover-class="hover">
										<div>
											<text>中医典籍</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/dietary_health_preservation/table','get')">
									<navigator class="my_module" url="/pages/dietary_health_preservation/table" hover-class="hover">
										<div>
											<text>饮食养生</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/disease_control/table','get')">
									<navigator class="my_module" url="/pages/disease_control/table" hover-class="hover">
										<div>
											<text>疾病防治</text>
											<span>></span>
										</div>
