<template>
	<view class="page_traditional_chinese_medicine_classics diy_list diy_list_page div_list_tml" id="traditional_chinese_medicine_classics_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
													<uni-search-bar placeholder="搜索典籍名称" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'name_of_classics')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																			<uni-search-bar placeholder="搜索典籍类型" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'types_of_classics')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																	<!-- /搜索栏 -->
						</view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?traditional_chinese_medicine_classics_id=' + o['traditional_chinese_medicine_classics_id']" class="btn btn-primary">查看详情</navigator>
...
<script>
	 ...
	 */
	get_praise(list){
		this.$get("~/api/praise/count_group?groupby=source_id&source_table=traditional_chinese_medicine_classics", {}, (res) => {
			if(res.result){
				res.result.map((o)=>{
					for(var i = 0;i < list.length; i++){
						var oj = list[i];
						if(oj["traditional_chinese_medicine_classics_id"] === o["source_id"]){
